...
part 'verify_transaction_response.g.dart';
...
class VerifyTransactionResponse {
    ...
    factory VerifyTransactionResponse.fromJson(Map<String, dynamic> json) => _$VerifyTransactionResponseFromJson(json);

    Map<String, dynamic> toJson() => _$VerifyTransactionResponseToJson(this);
}
